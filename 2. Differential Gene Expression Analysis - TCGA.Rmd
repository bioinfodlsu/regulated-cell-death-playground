...
From https://chipster.csc.fi/manual/deseq2-transform.html: Note that you can use the resulting transformed values only for visualization and clustering, not for differential expression analysis which needs raw counts.
