...
## II. Downloading the TCGA miRNA expression data 
...
lapply(rcd_refseq.unique_ids, write, rcd_mrna_file, append = TRUE, ncolumns = 1)
```
...
```{r}
ggplot(deseq.bbl.data, aes(x = cancer_type, y = rownames(deseq.bbl.data), size = padj, fill = log2FoldChange)) +
