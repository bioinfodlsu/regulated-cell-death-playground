...
```
python 7-get-unique-genes.py --rcd-gene-list-dir ../data/public/rcd-gene-list/RCDdb --output-dir ../data/public/rcd-gene-list/unique-genes/necroptosis-ferroptosis-pyroptosis
```
