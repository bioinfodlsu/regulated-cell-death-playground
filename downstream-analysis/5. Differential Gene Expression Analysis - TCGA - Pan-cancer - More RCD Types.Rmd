...
```
wget http://chenyclab.com/RCDdb/download/Apoptosis.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Entotic_cell_death.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Necroptosis.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Alkaliptosis.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Ferroptosis.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/NETotic_cell_death.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Autophagy_dependent_cell_death.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Immunogenic_cell_death.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Oxeiptosis.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Cuproptosis.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Lysosome_dependent_cell_death.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Parthanatos.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Disulfidptosis.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/MPT_driven_necrosis.csv -P ../data/public/rcd-gene-list/RCDdb/
wget http://chenyclab.com/RCDdb/download/Pyroptosis.csv -P ../data/public/rcd-gene-list/RCDdb/
```
