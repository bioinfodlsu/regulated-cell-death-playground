...
**NOTE: `VALUE` and `VALUE1` are the same. This is just a workaround since R's `heatmap.2` requires the heatmap to be at least two columns.**

```{r, fig.height=30, fig.width=10}
tpm.df[["VALUE1"]] = tpm.df[["VALUE"]]
tpm.matrix <- as.matrix(tpm.df)
heatmap.2(tpm.matrix, srtCol=360, 
          cellnote = tpm.matrix, 
